...
$(function() {    
                    ...
                    .on("mousemove", function (d, i) {
                        ...
                        tooltip.html(
                            "<ul class='list-unstyled mb-5'>" +
                                ...
                                "<li>" + "بازدید: &nbsp;" + "<span class='text-semibold pull-right'>" + pro + "</span>" + "</li>" +
                                "<li>" + "زمان: &nbsp; " + "<span class='text-semibold pull-right'>" + formatDate(d.values[mousedate].date) + "</span>" + "</li>" + 
                            "</ul>"
                        )
                        .style("display", "block");
        ...
        var tooltip = d3.tip()
            ...
            .html(function (d) {
                return "<ul class='list-unstyled mb-5'>" +
                    ...
                    "<li>" + "فروشها: &nbsp;" + "<span class='text-semibold pull-right'>" + d.value + "</span>" + "</li>" +
                    "<li>" + "درامد: &nbsp; " + "<span class='text-semibold pull-right'>" + "$" + (d.value * 25).toFixed(2) + "</span>" + "</li>" + 
                "</ul>";
            });
        ...
        var tip = d3.tip()
            ...
            .html(function (d) {
                return "<ul class='list-unstyled mb-5'>" +
                    ...
                    "<li>" + "بازدید: &nbsp;" + "<span class='text-semibold pull-right'>" + d.value + "</span>" + "</li>" +
    ...
    function generateBarChart(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
        ...
        if(tooltip == "hours") {
            tip.html(function (d, i) {
                return "<div class='text-center'>" +
                        ...
                        "<span class='text-size-small'>جلسات</span>" +
        ...
        if(tooltip == "goal") {
            tip.html(function (d, i) {
                return "<div class='text-center'>" +
                        "<h6 class='no-margin'>" + d + "</h6>" +
                        "<span class='text-size-small'>بیانیه</span>" +
                        "<div class='text-size-small'>" + i + ":00" + "</div>" +
                    "</div>"
            });
        }
        ...
        if(tooltip == "members") {
            tip.html(function (d, i) {
                return "<div class='text-center'>" +
                        ...
                        "<span class='text-size-small'>اعضا</span>" +
                        "<div class='text-size-small'>" + i + ":00" + "</div>" +
                    "</div>"
            });
        }
    ...
    // Initialize charts
    progressCounter('#hours-available-progress', 38, 2, "#F06292", 0.68, "icon-watch text-pink-400", 'ساعات دردسترس', '64% میانگین')
    progressCounter('#goal-progress', 38, 2, "#5C6BC0", 0.82, "icon-trophy3 text-indigo-400", 'هدف بهره وری', '87% میانگین')
